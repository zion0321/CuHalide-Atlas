...
function patchBody(body){if(!body)return body;try{return JSON.stringify(patchValue(JSON.parse(String(body))))}catch{return String(body).replaceAll('Current Curated rev.9','Current Curated rev.10').replaceAll('Current Curated rev.8','Current Curated rev.10').replaceAll('current-curated-r9','current-curated-r10').replaceAll('current-curated-r8','current-curated-r10').replaceAll('current-r9','current-r10').replaceAll('current-r8','current-r10').replaceAll('2026-08-19','2026-09-14')}}
