...
const RELEASE='3.0.2',META_VERSION='50.5',PUBLIC_DATA_VERSION='2.16.0',PHOTOPHYSICS_VERSION='1.3.2',ORGANIC_COMPONENTS_VERSION='1.1.0',CURRENT_REVISION='7',PUBLICATION_STATE='prepublication-review';
...
function normalizeHealth(x,ph,org){
  ...
  x.site_probe_mode='frontend v50 active; backend Current Curated rev.7 deterministic contract; Structured Photophysics 1.3.2 staged publication; Organic Components 1.1.0 structure-grain fail-closed depiction contract';
...
async function health(){
  ...
  const [runtime,photo,organic]=await Promise.all([
    ...
    fetchJsonWithRetry(PHOTOPHYSICS_HEALTH,'CuHalide-Atlas-Meta-Photophysics/1.3.2'),
