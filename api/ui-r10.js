...
function patch(body){
 ...
 x=all(x,"[['Article audit',r.article_audit_records,'all audited DOI records'],['Canonical articles',r.canonical_verified_articles,'scientific core']","[['Articles',410,'DOI-deduplicated literature corpus'],['Searchable full text',384,'current-catalog articles with native v2 text']");
