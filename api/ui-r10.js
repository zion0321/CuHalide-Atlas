...
function patch(body){
  ...
  x=all(x,'<meta name="cuhalide-site-version" content="51">','<meta name="cuhalide-site-version" content="52">');
  x=all(x,'cc.canonical_verified_articles||370','cc.canonical_verified_articles||372');
  x=all(x,'cc.core_included_structure_rows||890','cc.core_included_structure_rows||901');
  x=all(x,'cc.verified_space_group_rows||720','cc.verified_space_group_rows||734');
  x=all(x,'cc.strict_polar_rows||91','cc.strict_polar_rows||94');
  x=all(x,'cc.strict_polar_articles||57','cc.strict_polar_articles||60');
  x=all(x,'cc.structure_phase_rows||947','cc.structure_phase_rows||939');
