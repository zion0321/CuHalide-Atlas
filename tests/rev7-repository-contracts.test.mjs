...
test('Motif Atlas reflects the adjudicated rev.7 taxonomy without formula completion',()=>{
  ...
  for(const token of ["REV='7'","CONTENT_DATE='2026-08-19'",'motif_resolved_rows??610','motif_unresolved_rows??336',"version:'current-r7'",'Current Curated rev.7'])assert.ok(motifs.includes(token),`motif contract missing ${token}`);
