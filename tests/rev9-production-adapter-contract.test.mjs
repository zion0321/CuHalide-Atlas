...
test('citation, CodeMeta and prepublication privacy boundaries are rev.10',()=>{
  ...
  assert.match(meta,/const LITERATURE=\{articles:410,searchable_source_articles:387,native_v2_searchable_articles:384,fulltext_v2_doi_records:403,source_documents:727,text_blocks:6275/);
