...
test('manifest health data gateway citation assistant export and sitemap expose one governance state',async({request},testInfo)=>{
  ...
  expect(manifest.runtime).toMatchObject({site_version:'50',ui_version:'50.2',meta_version:'50.5',public_data_version:'2.16.0',photophysics_contract_version:'1.3.1',organic_components_contract_version:'1.1.0'});
  ...
  expect(health).toMatchObject({ok:true,status:'PASS',site_readiness:'PASS',meta_version:'50.5',gateway_meta_version:'50.5',publication_state:STATE,public_data_version:'2.16.0',photophysics_contract_version:'1.3.1',organic_components_contract_version:'1.1.0'});
  ...
  expect(data.record_context).toMatchObject({serving_context:'current_curated',serving_revision:7,core_record_origin:'frozen_release',core_record_origin_release:'3.0.2',attached_photophysics_context:'current_curated',attached_photophysics_contract:'1.3.1'});
