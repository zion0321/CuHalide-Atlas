export const config={matcher:['/','/index.html','/api/site','/api/ui-site','/api/ui-site.js','/api/ui-assistant','/api/ui-assistant.js','/api/ui-assistant-current','/api/ui-assistant-current.js','/api/record','/api/record.js','/api/record-current','/api/record-current.js','/api/record-evidence-current','/api/record-evidence-current.js']};
const LAST_MODIFIED=new Date('2026-08-19T00:00:00Z').toUTCString();
const REV='9',UI='51.0',SITE='51',PH='1.4.0',OC='1.2.0',STATE='prepublication-review';
