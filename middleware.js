...
const LAST_MODIFIED=new Date('2026-08-17T00:00:00Z').toUTCString();
export default async function middleware(request){
  ...
  headers.set('x-cuhalide-middleware','release-3.0.2-ui-v50.0-current-r5');
  headers.set('x-cuhalide-current-curated-revision','5');
  headers.set('x-cuhalide-ui-version','50.0');
