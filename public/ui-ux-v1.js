/* CuHalide Atlas UI 52 portal UX bootstrap. */
(() => {
  'use strict';
  ...
  load('/ui-ux-core-v1.js?v=52.0','portal-ux-core-v52').then(()=>ready(installPolishObservers)).catch(e=>console.warn('[ui52 ux]',e));
