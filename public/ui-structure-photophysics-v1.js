...
(() => {
  ...
  function mappedCard(ph,id){
    const samples=Array.isArray(ph.samples)?ph.samples:[],mapped=samples.filter(s=>String(s.structure_id||'')===id||String(s.mapping_status||'').startsWith('structure_'));
