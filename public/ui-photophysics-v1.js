...
(() => {
  ...
  function injectView(){
    ...
    target.insertAdjacentHTML('beforebegin',`<section class="view photo-view" data-view="photophysics">
      <div class="shell page-head"><p class="eyebrow">Structured photophysics · contract 1.3.1</p><h1>Photophysics at the correct experimental grain</h1><p>Browse the new curated layer without conflating a crystal, powder, composite, film or device. Pass A and independent two-pass verification are shown separately, and unresolved source conflicts remain fail-closed.</p></div>
