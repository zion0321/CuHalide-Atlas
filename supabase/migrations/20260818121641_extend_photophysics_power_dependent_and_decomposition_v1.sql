...
alter table atlas_internal.cuhalide_photophysics_measurement_v1
  ...
  check (measurement_type in (
    ...
    'time_resolved_pl','plqy','temperature_dependent_pl','excitation_dependent_pl','power_dependent_pl','pressure_dependent_pl',
...
values
('thermal_decomposition_temperature','stability','degC','Source-reported thermal decomposition or onset temperature under the stated thermal-analysis protocol.',false,true,false,'Retain atmosphere and heating protocol in measurement conditions; do not conflate with a phase-transition temperature.')
