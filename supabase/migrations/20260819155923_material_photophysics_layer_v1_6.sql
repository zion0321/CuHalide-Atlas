-- CuHalide Atlas material-grain photophysics layer v1.6.
-- Internal quantum yield (IQY) is stored explicitly rather than silently relabelled as PLQY.
...
alter table public.cuhalide_atlas_photophysics_measurements
  ...
  check (property_code in (
    ...
    'absorption_peak_nm','absorption_edge_nm','fwhm_nm','plqy_fraction','internal_quantum_yield_fraction','lifetime_us',
  ...
  check (
    ...
    and (
      property_code not in ('emission_peak_nm','emission_range_nm','excitation_peak_nm','excitation_range_nm',
        ...
        'detection_limit_ngy_s','detection_limit_ngyair_s','spatial_resolution_lp_mm','afterglow_ms',
        'luminance_cd_m2','device_t50_h','cct_k')
      or (
