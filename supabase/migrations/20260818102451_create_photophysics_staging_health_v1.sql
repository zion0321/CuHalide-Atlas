...
select jsonb_build_object(
  'ok', (
    ...
    checks.conflict_flag_without_registry=0 and checks.conflict_registry_without_flag=0 and checks.eligible_values_without_evidence=0 and
    checks.invalid_intrinsic_scope=0 and checks.confounded_intrinsic_samples=0 and checks.invalid_structure_exact_mappings=0 and
    checks.measured_without_measurement=0 and checks.no_measurement_status_with_measurement=0 and checks.no_measurement_without_note=0 and
    checks.legacy_hint_evidence_violations=0 and checks.unknown_property_keys=0 and checks.duplicate_measurements=0 and checks.duplicate_bands=0 and
    checks.completed_review_missing_two_pass_gate=0
  ),
